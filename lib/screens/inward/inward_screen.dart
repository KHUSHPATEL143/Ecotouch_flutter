...
final inwardListProvider = FutureProvider.family<List<Inward>, DateTime>((ref, date) async {
...
class _InwardScreenState extends ConsumerState<InwardScreen> {
  ...
  Future<void> _handleExport() async {
    ...
    try {
      ...
      if (data.isEmpty) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No inward records found for selected period')),
          );
        }
        return;
      }

      final headers = ['Date', 'Material Name', 'Pack Size (kg)', 'Packs', 'Total Weight (kg)', 'Notes'];
      ...
      final title = 'Inward Report (${app_date_utils.DateUtils.formatDate(start)} - ${app_date_utils.DateUtils.formatDate(end)})';
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                _editingId == null ? 'New Supply Entry' : 'Edit Supply Entry',
                          ...
                          const SizedBox(height: 24),
                           ...
                           // Material Dropdown
                              materialsAsync.when(
                                data: (materials) => DropdownButtonFormField<RawMaterial>(
                              ...
                              TextFormField(
                                ...
                                validator: (value) => Validators.positiveNumber(value, fieldName: 'Pack Size'),
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                        ...
                                        keyboardType: TextInputType.number,
                                        validator: (value) => Validators.positiveInteger(value, fieldName: 'Bag Count'),
                                        onChanged: (_) => setState(() {}),
                                      ),
                                  ),
                                  ...
                                  Expanded(
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.circular(4), // Match border radius default
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  label: Text(_editingId == null ? 'Add to Stock' : 'Update Entry'),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Spacer(),
                                StatusBadge(
                                  label: '${inwardAsync.value?.length ?? 0} Entries',
                                  ...
                                  if (inwardList.isEmpty) {
                                    return Center(
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                          Icon(Icons.arrow_downward, size: 48, color: Theme.of(context).hintColor.withOpacity(0.3)),
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  const SizedBox(height: 2),
                                                  Text(inward.notes ?? '-', maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 11, color: Theme.of(context).hintColor)),
                                                ],
                                              ),
                                            ),
                                            IconButton(
                                              icon: const Icon(Icons.edit_outlined, size: 18),
                                              onPressed: () => _editInward(inward),
                                              tooltip: 'Edit',
                                              color: AppColors.primaryBlue,
                                              padding: EdgeInsets.zero,
                                            ...
                                            IconButton(
                                              ...
                                              onPressed: () => _deleteInward(inward),
                                              tooltip: 'Delete',
  ...
  Future<void> _submitEntry() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_editingId != null ? 'Inward entry updated successfully' : 'Inward entry recorded successfully'),
  ...
  Future<void> _deleteInward(Inward inward) async {
    ...
    if (confirm == true && inward.id != null) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Entry deleted'), backgroundColor: AppColors.success),
        );
      }
    }
  }
