...
class InwardReportTab extends ConsumerWidget {
               ...
               children: [
                 ...
                 dataAsync.when(
                   data: (data) {
                     ...
                     final totalValue = (totals['total_value'] as num?)?.toDouble() ?? 0.0;
                         ...
                         data: (data) {
                           ...
                           if (list.isEmpty) {
                             return const Padding(
                               ...
                               child: Center(child: Text("No inward records found for this period.")),
                             );
                           }
  ...
  Future<void> _handleExport(BuildContext context, AsyncValue<Map<String, dynamic>> dataAsync) async {
    ...
    final headers = ['Material Name', 'Pack Size (kg)', 'Count', 'Weight (kg)'];
